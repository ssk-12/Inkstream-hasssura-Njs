...
import { createBlog } from '@/app/lib/actions/createBlog';
...
export default function CreateBlog() {
    ...
    const handleBackToDashboard = () => {
        ...
        return <div className="flex flex-col gap-3 p-16 justify-between items-center w-[500px] mx-8">
            <div>
            <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            className="m-1 p-2 block w-full rounded-md border-2 focus:ring-blue-500 focus:border-black"
                            required
                        />
                    </div>
                    <div>
